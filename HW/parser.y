...
%token BOOL_LITERAL CHAR_LITERAL INT_LITERAL DOUBLE_LITERAL FLOAT_LITERAL STRING_LITERAL IDENTIFIER
...
assignment:
    IDENTIFIER ASSIGN expression SEMICולON
    {
        $$ = create_node("ASSIGN", $3, NULL, NULL, $1);
    }
    | LBRACKET IDENTIFIER RBRACKET ASSIGN expression SEMICולON
    {
        $$ = create_node("ASSIGN_ARRAY", $5, NULL, NULL, $2);
    }
    | MULTIPLY IDENTIFIER ASSIGN expression SEMICולON
    {
...
for_statement:
    FOR LPAREN assignment expression SEMICולON assignment RPAREN statement
    {
...
do_while_statement:
    DO statement WHILE LPAREN expression RPAREN SEMICולON
    {
