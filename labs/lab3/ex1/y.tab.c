...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from test2.y  */
...
const int YY_parse_CLASS::AUGUST=258;
const int YY_parse_CLASS::SEPTEMBER=259;
const int YY_parse_CLASS::OCTOBER=260;
const int YY_parse_CLASS::NOVEMBER=261;
const int YY_parse_CLASS::DECEMBER=262;
const int YY_parse_CLASS::YEAR=263;
...
static const char * const yytname[] = {   "$","error","$illegal.","AUGUST","SEPTEMBER",
"OCTOBER","NOVEMBER","DECEMBER","YEAR","'#'","s","month",""
};
#endif
...
-32768,-32768,-32768,-32768,-32768,    -4,    -2,-32768,     7,     8,
-32768
};
